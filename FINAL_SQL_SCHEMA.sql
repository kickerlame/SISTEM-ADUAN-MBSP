...
-- ============================================
-- This is the CORRECTED version based on all code changes
...
-- Officers have username/password directly (no separate users table link)
CREATE TABLE `officers` (
  `officer_id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(50) NOT NULL COMMENT 'Login username',
  `password` varchar(255) NOT NULL COMMENT 'Hashed password',
  `role` enum('admin','officer') NOT NULL COMMENT 'admin or officer',
  `status` enum('active','offline') DEFAULT 'active' COMMENT 'active or offline',
  `full_name` varchar(100) NOT NULL COMMENT 'Full name of officer',
  `staff_id` varchar(20) NOT NULL COMMENT 'Staff ID number (auto-generated)',
...
-- ============================================
-- This is for regular public users who file complaints
-- NO role field - all users in this table are public users
CREATE TABLE `users` (
...
-- ============================================
-- Updated: user_id references users table (for public users)
-- Note: For officer actions, we can add officer_id field later if needed
CREATE TABLE `complaint_logs` (
  `log_id` int(11) NOT NULL AUTO_INCREMENT,
  `complaint_id` int(11) NOT NULL,
  `user_id` int(11) DEFAULT NULL COMMENT 'User who made change (from users table)',
...
SELECT 'Database schema created successfully!' AS Status,
       'Structure: officers (admin/staff), users (public users), all relationships correct' AS Note;
